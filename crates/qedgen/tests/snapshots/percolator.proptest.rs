// ---- GENERATED BY QEDGEN ---- spec-hash:9bf1aa4961157be7
//
...
fn add_user(s: &mut State, i: usize) -> bool {
    if !((s.accounts[(i) as usize].active == 0) && (((s.accounts[(i) as usize].capital) as i128).wrapping_add(((s.accounts[(i) as usize].pnl) as i128)) >= ((0) as i128))) {
        return false;
    }
...
fn deposit(s: &mut State, i: usize, amount: u128) -> bool {
    if !((s.accounts[(i) as usize].active == 1) && (((s.V) as u128).wrapping_add(((amount) as u128)) <= ((10000000000000000) as u128))) {
        return false;
    }
    if s.status != Status::Active {
        return false;
...
fn withdraw(s: &mut State, i: usize, amount: u128) -> bool {
    if !((s.accounts[(i) as usize].active == 1) && (s.accounts[(i) as usize].capital >= amount) && (((s.accounts[(i) as usize].capital) as i128).wrapping_add(((s.accounts[(i) as usize].pnl) as i128)) >= ((amount) as i128))) {
        return false;
    }
    if s.status != Status::Active {
        return false;
...
fn top_up_insurance(s: &mut State, amount: u128) -> bool {
    if !((((s.V) as u128).wrapping_add(((amount) as u128)) <= ((10000000000000000) as u128))) {
        return false;
    }
    if s.status != Status::Active {
        return false;
...
fn liquidate_case_0(s: &mut State, i: usize) -> bool {
    if !((s.accounts[(i) as usize].active == 1) && (((s.accounts[(i) as usize].capital) as i128).wrapping_add(((s.accounts[(i) as usize].pnl) as i128)) >= ((0) as i128)) && (false)) {
        return false;
    }
    if s.status != Status::Active {
        return false;
...
proptest! {
    ...
    fn add_user_rejects_invalid(s in arb_boundary_state(), i in prop_oneof![0u64..=3u64, (u64::MAX - 3)..=u64::MAX]) {
        let mut s = s;
        prop_assume!(!((s.accounts[(i) as usize].active == 0) && (((s.accounts[(i) as usize].capital) as i128).wrapping_add(((s.accounts[(i) as usize].pnl) as i128)) >= ((0) as i128))));
...
proptest! {
    ...
    fn deposit_rejects_invalid(s in arb_boundary_state(), i in prop_oneof![0u64..=3u64, (u64::MAX - 3)..=u64::MAX], amount in prop_oneof![0u128..=3u128, (u128::MAX - 3)..=u128::MAX]) {
        let mut s = s;
        prop_assume!(!((s.accounts[(i) as usize].active == 1) && (((s.V) as u128).wrapping_add(((amount) as u128)) <= ((10000000000000000) as u128))));
...
proptest! {
    ...
    fn withdraw_rejects_invalid(s in arb_boundary_state(), i in prop_oneof![0u64..=3u64, (u64::MAX - 3)..=u64::MAX], amount in prop_oneof![0u128..=3u128, (u128::MAX - 3)..=u128::MAX]) {
        let mut s = s;
        prop_assume!(!((s.accounts[(i) as usize].active == 1) && (s.accounts[(i) as usize].capital >= amount) && (((s.accounts[(i) as usize].capital) as i128).wrapping_add(((s.accounts[(i) as usize].pnl) as i128)) >= ((amount) as i128))));
...
proptest! {
    ...
    fn top_up_insurance_rejects_invalid(s in arb_boundary_state(), amount in prop_oneof![0u128..=3u128, (u128::MAX - 3)..=u128::MAX]) {
        let mut s = s;
        prop_assume!(!((((s.V) as u128).wrapping_add(((amount) as u128)) <= ((10000000000000000) as u128))));
...
proptest! {
    ...
    fn liquidate_case_0_rejects_invalid(s in arb_boundary_state(), i in prop_oneof![0u64..=3u64, (u64::MAX - 3)..=u64::MAX]) {
        let mut s = s;
        prop_assume!(!((s.accounts[(i) as usize].active == 1) && (((s.accounts[(i) as usize].capital) as i128).wrapping_add(((s.accounts[(i) as usize].pnl) as i128)) >= ((0) as i128)) && (false)));

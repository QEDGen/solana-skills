...
pub fn render(spec: &ParsedSpec, hash: &str) -> String {
    ...
    // Header
    out.push_str(&format!(
        "// ---- GENERATED BY QEDGEN — DO NOT EDIT ---- spec-hash:{}\n",
        hash
    ));
...
fn emit_account_helpers(out: &mut String, state_name: &str, spec: &ParsedSpec, needs_token: bool) {
    ...
    // signer()
    out.push_str("fn signer(address: Pubkey) -> Account {\n");
    out.push_str("    quasar_svm::token::create_keyed_system_account(&address, 10_000_000_000)\n");
    out.push_str("}\n\n");

    // empty()
    out.push_str("fn empty(address: Pubkey) -> Account {\n");
    out.push_str("    Account {\n");
    out.push_str("        address,\n");
    out.push_str("        lamports: 0,\n");
    out.push_str("        data: vec![],\n");
    out.push_str("        owner: quasar_svm::system_program::ID,\n");
    ...
    if needs_token {
        out.push_str("fn mint_account(address: Pubkey, authority: Pubkey) -> Account {\n");
        out.push_str("    quasar_svm::token::create_keyed_mint_account(\n");
        out.push_str("        &address,\n");
        out.push_str("        &Mint {\n");
        out.push_str("            mint_authority: Some(authority).into(),\n");
        out.push_str("            supply: 1_000_000_000,\n");
        out.push_str("            decimals: 9,\n");
        out.push_str("            is_initialized: true,\n");
        out.push_str("            freeze_authority: None.into(),\n");
        out.push_str("        },\n");
        out.push_str("    )\n");
        out.push_str("}\n\n");
        ...
        out.push_str("    quasar_svm::token::create_keyed_token_account(\n");
        out.push_str("        &address,\n");
        out.push_str("        &TokenAccount {\n");
        out.push_str("            mint,\n");
        out.push_str("            owner,\n");
        out.push_str("            amount,\n");
        out.push_str("            state: AccountState::Initialized,\n");
        out.push_str("            ..TokenAccount::default()\n");
        out.push_str("        },\n");
        out.push_str("    )\n");
        out.push_str("}\n\n");
    }
...
mod tests {
    ...
    const ESCROW_SPEC: &str =
        include_str!("../../../examples/rust/escrow/formal_verification/escrow.qedspec");

...
/// Happy path: Create a new multisig vault with members and approval threshold
#[test]
...
/// Happy path: Submit a new transaction proposal — any vault member can propose
#[test]
fn test_propose() {
    let mut svm = setup();
...
/// Happy path: Approve the current proposal — each member may approve once
#[test]
fn test_approve() {
    let mut svm = setup();
...
/// Happy path: Execute the proposal once the approval threshold is met
#[test]
fn test_execute() {
    let mut svm = setup();
...
/// Happy path: Cancel the current proposal and return to accepting new proposals
#[test]
...
/// Happy path: Remove a member from the vault — creator only
#[test]

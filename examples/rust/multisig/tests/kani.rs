// ---- GENERATED BY QEDGEN ---- spec-hash:aa292de50d567cd1
//
...
#[kani::unwind(2)]
#[kani::solver(cadical)]
fn verify_approve_preserves_votes_bounded() {
    let mut s = State {
        threshold: kani::any(),
        member_count: kani::any(),
        members: kani::any(),
...
#[kani::unwind(2)]
#[kani::solver(cadical)]
fn verify_reject_preserves_votes_bounded() {
    let mut s = State {
        threshold: kani::any(),
        member_count: kani::any(),
        members: kani::any(),
...
#[kani::unwind(2)]
#[kani::solver(cadical)]
fn verify_add_member_preserves_votes_bounded() {
    let mut s = State {
        threshold: kani::any(),
        member_count: kani::any(),
        members: kani::any(),

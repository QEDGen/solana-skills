// ---- GENERATED BY QEDGEN — DO NOT EDIT ---- spec-hash:1be16f67d637932b
...
/// Happy path: Initializer deposits tokens and opens the escrow
#[test]
fn test_initialize() {
    let mut svm = setup();
...
/// Happy path: Taker completes the trade by sending their tokens
#[test]
fn test_exchange() {
    let mut svm = setup();
...
/// Happy path: Initializer reclaims their deposit and closes the escrow
#[test]
fn test_cancel() {
    let mut svm = setup();

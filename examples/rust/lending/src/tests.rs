...
mod tests {
    ...
    fn test_init_pool_preserves_pool_solvency() {
        ...
        assert!(∀ s : Pool.Active, state.total_deposits >= state.total_borrows, "pool_solvency must hold after init_pool");
    }
    ...
    fn test_deposit_preserves_pool_solvency() {
        ...
        assert!(∀ s : Pool.Active, state.total_deposits >= state.total_borrows, "pool_solvency must hold after deposit");
    }

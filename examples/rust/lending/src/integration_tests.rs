// ---- GENERATED BY QEDGEN — DO NOT EDIT ---- spec-hash:a7cc732944f311f2
...
/// Happy path: Initialize the lending pool with an interest rate
#[test]
fn test_init_pool() {
    let mut svm = setup();
...
/// Happy path: Deposit tokens into the pool
#[test]
fn test_deposit() {
    let mut svm = setup();
...
/// Happy path: Borrow tokens from the pool against collateral
#[test]
fn test_borrow() {
    let mut svm = setup();
...
/// Happy path: Repay a loan in full
#[test]
fn test_repay() {
    let mut svm = setup();
...
/// Happy path: Liquidate an undercollateralized loan
#[test]
fn test_liquidate() {
    let mut svm = setup();

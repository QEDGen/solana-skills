// ---- GENERATED BY QEDGEN — DO NOT EDIT ABOVE THIS LINE ---- spec-hash:4e83827ce266ed33
...
pub struct Borrow {
    #[account(mut)]
    pub borrower: Signer,
    #[account(mut, init, payer = borrower, seeds = LendingAccount::seeds(loan), bump)]
    pub loan: Account<()>,
    #[account(mut, init, payer = borrower, seeds = LendingAccount::seeds(pool), bump)]
    pub pool: Account<()>,

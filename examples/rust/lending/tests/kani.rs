// ---- GENERATED BY QEDGEN ---- spec-hash:dd4a1ed9d28ef53c
//
...
fn verify_deposit_effects() {
    ...
    if deposit(&mut s, amount) {
        assert!(s.total_deposits == pre_total_deposits + amount, "total_deposits must increment by amount");

...
--
-- DropsetSpec.lean is generated by `qedgen lean-gen` from dropset.qedspec.
-- P1-P7: wp_exec proofs provided here. P8-P13: manual wp_step proofs.
--
...
-- End-to-end: lean-gen spec (DropsetSpec) → proven instance (zero sorry, zero wrappers)
-- P1-P7: wp_exec proofs (DropsetProofs namespace)
-- P8-P13: manual proofs (DropsetProofs namespace)
